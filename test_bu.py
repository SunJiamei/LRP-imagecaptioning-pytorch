...
if __name__ == '__main__':
    ...
    # model_weight_paths = glob.glob('./output/gridTD_BU_lrpfinetune/vgg16/flickr30k/checkpoint_flickr30k_epoch9*')
    model_weight_paths = glob.glob('./output/aoa_bu_lrpfinetune/vgg16/flickr30k/checkpoint_flickr30k_epoch14*')
    # model_weight_paths = glob.glob('./output/aoa_bu_cideropt/vgg16/flickr30k/checkpoint_flickr30k_epoch4_cider_0.6431948823397436.pth*')
    # model_weight_paths= glob.glob('./output/gridTD_BU_lrpcideropt/vgg16/cocorobust/checkpoint_cocorobust_epoch23*')
